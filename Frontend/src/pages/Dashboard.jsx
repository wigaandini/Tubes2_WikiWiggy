...
export default function Dashboard() {
  return (
    <div>
      <Box 
        bgGradient="linear(to-b, white, #fbd7e6, #db9fb8)" 
        minHeight="185vh" 
        pt="30px"
      >
        ...
        >
          ...
          <Box textAlign="center">
            <Button as={Link} to="/bfs-page" variant="none" _hover={{ bg: "transparent", transform: "scale(1.2)", transition: "transform 0.3s ease-in-out" }}>
              <img src={bubblesImage} alt="Bubbles" style={{ width: '50%', height: 'auto' }} />
            </Button>
          </Box>

          <Box textAlign="center">
            <Button as={Link} to="/ids-page" variant="none" _hover={{ bg: "transparent", transform: "scale(1.2)", transition: "transform 0.3s ease-in-out"  }}>
